...
@pytest.mark.slow
def test_tower_defense_harness_execution(tmp_path):
    """Test that the tower_defense harness loads and runs correctly."""
    html = Path('/workspace/harness/tower_defense.html').read_text()
